...
export function ResearchToolbar({ symbol }: ResearchToolbarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <div className="mr-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-white/40 sm:text-[11px]">
        Evidence for
      </div>
      <div className="rounded-lg border border-cyan-500/30 bg-cyan-500/10 px-2.5 py-1.5 text-xs font-bold text-cyan-200">
        ${symbol}
      </div>
      <button
        type="button"
        ...
        className={cn(
          "inline-flex min-h-[36px] items-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-semibold transition active:scale-95",
          saved
      ...
      <Link
        ...
        className="inline-flex min-h-[36px] items-center gap-1.5 rounded-lg border border-white/15 bg-white/5 px-3 py-2 text-xs font-semibold text-white/80 transition hover:border-cyan-500/40 hover:text-cyan-200 active:scale-95"
      >
